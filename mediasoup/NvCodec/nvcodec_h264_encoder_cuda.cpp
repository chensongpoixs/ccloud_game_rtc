...
NvEncoder* NvCodecH264EncoderCudaImpl::CreateNvEncoder(int width,
                                                       int height,
                                                       bool use_native) {
	NV_ENC_BUFFER_FORMAT nvenc_format = NV_ENC_BUFFER_FORMAT_ABGR10;// NV_ENC_BUFFER_FORMAT_ARGB10;  /*use_native ? NV_ENC_BUFFER_FORMAT_NV12 : NV_ENC_BUFFER_FORMAT_IYUV;*/
